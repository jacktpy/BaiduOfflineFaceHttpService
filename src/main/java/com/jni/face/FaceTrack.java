...
public class FaceTrack {
    ...
    public int imageTrack() {
        ...
        // type 0： 表示rgb 人脸检测 1：表示nir人脸检测
        int type = 0;
        TrackFaceInfo[] boxList = Face.track(matAddr, type);
        ...
        for (int i = 0; i < boxList.length; i++) {
            ...
            // 人脸框宽度
            System.out.println("face width is:" + boxList[i].box.width);
            // 人脸框高度
            System.out.println("face height is:" + boxList[i].box.height);
         
            // 人脸框中心x坐标
            System.out.println("face center x is:" + boxList[i].box.centerx);
            // 人脸框中心y坐标
            System.out.println("face center y is:" + boxList[i].box.centery);
            // 人脸置信度
            System.out.println("face score is:" + boxList[i].box.score);
        }
